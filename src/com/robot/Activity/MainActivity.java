...
public class MainActivity extends Activity {
	...
	private void initView() {
		...
		mDatas.add(new ChatMessage(Type.INPUT, "我是机器人昂昂，很高兴为您服务"));
		// yy=(Button)findViewById(R.id.iv_main_yy);
	...
	public void sendyy(View v) {
		Intent it = new Intent(MainActivity.this, VoiceCharActivity.class);
		startActivity(it);
	}
